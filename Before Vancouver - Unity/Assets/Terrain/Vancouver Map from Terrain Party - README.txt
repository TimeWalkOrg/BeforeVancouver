...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Vancouver&box=-123.065262,49.326263,-123.175527,49.254397
...
-----------
  ...
  * Vancouver Height Map (ASTER 30m).png
  ...
  * Vancouver Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Vancouver Height Map (SRTM3 v4.1).png
  ...
  * Vancouver Height Map (SRTM30 Plus).png
